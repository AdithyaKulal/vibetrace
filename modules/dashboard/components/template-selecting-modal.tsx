    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#3d8a0c] flex items-center gap-2">
                <Plus size={24} className="text-[#3d8a0c]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        key={template.id}
                        className={`relative flex p-6 border-2 rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
    ${
      selectedTemplate === template.id
        ? "border-[#3d8a0c] shadow-[0_0_0_1px_#3d8a0c,0_8px_20px_rgba(61,138,12,0.15)]"
        : "border-transparent hover:border-[#3d8a0c] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.05)]"
    }
`}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#3d8a0c] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#3d8a0c] hover:bg-[#3d8a0c] text-white"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#3d8a0c]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#3d8a0c,0_8px_20px_rgba(233,63,63,0.15)] rounded-lg border">
                  ...
                  {templates
                    ...
                    ?.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        <Zap size={14} className="text-[#3d8a0c]" />
