...
export const PlaygroundEditor = ({
  ...
  useEffect(() => {
    return () => {
      ...
      if (inlineCompletionProviderRef.current) {
        // Inline completion providers return a true disposable object
        inlineCompletionProviderRef.current.dispose();
        inlineCompletionProviderRef.current = null;
      }
      if (tabCommandRef.current) {
        // 🌟 FIXED: Remove .dispose() since editor commands are strings, not objects.
        // They are automatically cleaned up when the main editor instance is disposed.
