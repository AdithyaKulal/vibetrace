...
// Change the top wrapper to this :
...
export function Header() {
  return (
    <>
      <div className="sticky top-0 z-50 flex justify-center w-full pt-">
        <div className="bg-white dark:bg-black/5 bg-transparent w-[95%] max-w-[850px]">
          ...
          <div className="flex items-center justify-center w-full flex-col">
            <div
              className={`
                            ...
                            w-full sm:min-w-0 sm:max-w-[1200px]
                            rounded-b-[28px]
                            px-4 py-2.5
                            relative
